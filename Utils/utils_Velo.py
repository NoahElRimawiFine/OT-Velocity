...
def OT_lagged_correlation(velocities_all_signed, velocities_signed, Ts_prior, normalization=True, stimulation=False, elastic_Net=False, alpha_opt=1.0, l1_opt=1.0,tune=False, g_s = None, g_t=None, return_slice=False, signed=False, lags=False):
